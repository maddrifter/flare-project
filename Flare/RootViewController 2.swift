...
//                self.addAnnoymous()
    ...
    private func addGoogleSign(){
        ...
        self.googleSignButton.backgroundColor = UIColor.red
    ...
    private func addAnnoymous(){
        ...
        self.annoyButton.setTitle("Annonymous", for: UIControlState.normal)
        self.annoyButton.backgroundColor = UIColor.green
