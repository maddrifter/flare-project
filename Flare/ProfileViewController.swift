...
//  Flare
//
//  Created by Halston v on 11/09/2016.
...
class ProfileViewController: UIViewController, UITextFieldDelegate, MFMessageComposeViewControllerDelegate {
    ...
    @IBAction func feedbackLink(_ sender: AnyObject) {
        UIApplication.shared.openURL(URL(string: "https://forms.typeform.io/to/5cmmR6jkJK")!)
    ...
    @IBAction func shareLink(_ sender: AnyObject) {
        // text to share
        let text = "I'm using this awesome new app called AfterParty! You should come join!"
    ...
    @IBAction func textCEO(_ sender: AnyObject) {
        ...
        messageVC.body = "Hello Customer Support";
        messageVC.recipients = ["+8019971522"]
        messageVC.messageComposeDelegate = self;
        
        self.present(messageVC, animated: false, completion: nil)
        FIRAnalytics.logEvent(withName: "customer support", parameters: nil)
